...
<head>
    ...
    <style>
        header .song_side::before
        {
           ...
           background: url('img/Raftar/raftar.png') no-repeat;
...
<body>
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
            <h1>Raftara</h1>
                <p>Kalathil Kuzhiyil Devadasan Dilin Nair 
                    <br>(born 16 November 1988), or Dilin Nair,
                    <br> better known by his stage name Raftaar,
                    <br> is an Indian rapper, lyricist, dancer, 
                    <br>TV personality and music composer associated with Hindi and Punjabi music. 
                </p>
                <div class="buttons">
                    <a href="https://www.youtube.com/@raftaarmusic"><button>PLAY</button></a>
                    <a href="https://www.instagram.com/raftaarmusic/"><button>FOLLOW</button></a>
                </div>    
            </div>
