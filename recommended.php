...
<head>
    ...
    header .song_side::before
    {
       ...
       background: url('new_music.png') no-repeat;
...
<body>
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1 style="margin-left: 20px;">Recommended Songs</h1>
                    <br>
                    <h4 style="color: white; margin-left:20px;" >This Songs are the Trending songs<br>Hope so you will Loved it....</h4>
