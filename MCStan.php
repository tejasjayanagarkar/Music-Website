...
<head>
    ...
    <style>
        header .song_side::before
        {
           ...
           background: url('img/mc stan/mc_stan.png') no-repeat;
...
<body>
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>MC Stan</h1>
                <p>MC Stan was born as Altaf Shaikh 
                    <br>(also known as Altaf Tadavi) on Monday, 30 August 1999 
                    <br> in Pune, Maharashtra. 
                    <br>The Times of India DNA India His zodiac sign is Virgo.
                    <br> He grew up in the neighbourhood of Tadiwala Road in Pune. 
                    <br>He completed his class 12th from a school in Pune
                </p>
                <div class="buttons">
                    <a href="https://www.youtube.com/results?search_query=mc+stan+channel"><button>PLAY</button></a>
                    <a href="https://www.instagram.com/m___c___stan/"><button>FOLLOW</button></a>
                </div>    
            </div>
