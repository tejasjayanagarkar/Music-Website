...
const songs = [
    {
        ...
        poster: "img/Lata Mangeshkar/1.jpg",
    },
    {
        id: '2',
        songName: `Apna Bana le<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Lata Mangeshkar/2.jpg",
    },
    {
        id: "3",
        songName: `Desh Mere<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Lata Mangeshkar/3.jpg",
    },
    {
        id: "4",
        songName: `Heer Ranjhana<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Lata Mangeshkar/4.jpg",
    },
    {
        id: "5",
        songName: `Heeriye<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Lata Mangeshkar/5.jpg",
    },
    {
        id: "6",
        songName: `Kala Jadu<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Lata Mangeshkar/6.jpg",
    },
    {
        id: "7",
        songName: `Kesariya<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Lata Mangeshkar/7.jpg",
    },
    {
        id: "8",
        songName: `Har Kisi Ko<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Lata Mangeshkar/8.jpg",
    },
    {
        id: "9",
        songName: `Jab Tak -M.S.Dhoni<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Lata Mangeshkar/9.jpg",
    },
    {
        id: "10",
        songName: `Khairiyat<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Lata Mangeshkar/10.jpg",
    },
    {
        id: "11",
        songName: `Dekha Ek Khawab<br><div class="subtitle">Lata Mangeshkar</div>`,
        poster: "img/Lata Mangeshkar/11.jpg",
    },
    {
        id: "12",
        songName: `Kabhi Khushi Kabhi Gam<br><div class="subtitle">Lata Mangeshkar</div>`,
        poster: "img/Lata Mangeshkar/12.jpg",
    },
    {
        id: "13",
        songName: `O Paalanhaare<br><div class="subtitle">Lata Mangeshkar</div>`,
        poster: "img/Lata Mangeshkar/13.jpg",
    },
    {
        id: "14",
        songName: `Tum Se Milkar Na Jan Kyun<br>
        <div class="subtitle">Lata Mangeshkar</div>`,
        poster: "img/Lata Mangeshkar/14.jpg",
    },
    {
        id: "15",
        songName: `Ajeeb Dastan Hai Yeh<br>
        <div class="subtitle">Lata Mangeshkar</div>`,
        poster: "img/Lata Mangeshkar/15.jpg",
    },  
    {
        id: "16",
        songName: `Lag Ja Gale<br>
        <div class="subtitle">Lata Mangeshkar</div>`,
        poster: "img/Lata Mangeshkar/16.jpg",
    },  
    {
        id: "17",
        songName: `Shayad Meri Shaadi<br>
        <div class="subtitle">Lata Mangeshkar</div>`,
        poster: "img/Lata Mangeshkar/16.jpg",
    }      
]
...
Array.from(document.getElementsByClassName("playlistPlay")).forEach((e)=>{
    e.addEventListener("click", (el)=>{
        ...
        music.src = `audio/Lata Mangeshkar/${index}.mp3`;

        download_music.href = `audio/Lata Mangeshkar/${index}.mp3`;

        poster_master_play.src = `img/Lata Mangeshkar/${index}.jpg`;
        music.play();
        masterPlay.classList.remove("bi-play-fill");
        masterPlay.classList.add("bi-pause-fill");
