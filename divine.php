...
<head>
    ...
    <style>
        header .song_side::before
        {
           ...
           background: url('img/Divine/divine1.png') no-repeat;
           background-size: 23% auto; /* Adjust the values as needed */    
        }
        </style>
</head>
<body>
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Divine</h1>
                <p>Vivian Wilson Fernandes (born 2 October 1990),
                    <br> known professionally as Divine (stylized as DIVINE),
                    <br> is an Indian rapper of Goan descent. 
                    <br>He was born and raised in Mumbai and started gaining popularity
                    <br> after the release of his song "Yeh Mera Bombay" in 2013.
                </p>
                <div class="buttons">
                    <a href="https://www.youtube.com/results?search_query=divine+channel"><button>PLAY</button>
                    <a href="https://www.instagram.com/vivianakadivine/"><button>FOLLOW</button></a>
                </div>    
            </div>
