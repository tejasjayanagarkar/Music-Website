...
<head>
    ...
    <style>
        header .song_side::before
        {
           ...
           background: url('img/A.R.Rahman/A.R.Rahman.png') no-repeat;
...
<body>
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
            <h1>A.R Rahman</h1>
                <p>Allah Rakha rahman
                    <br><b>6 January 1967</b>
                    <br> an Indian music composer, record producer, singer
                    <br> songwriter, musician, multi-instrumentalist and philanthropist,<br>
                    <br> popular for his works in Indian cinema
                    <br> predominantly in Tamil and Hindi films
                </p>
                <div class="buttons">
                    <a href="https://youtu.be/qi1hQ1JIvl0?si=nE_ZX4SLpaVgfCex"><button>PLAY</button></a>
                    <a href="https://www.instagram.com/arrahman"><button>FOLLOW</button></a>
                </div>    
            </div>
