...
<head>
    ...
    <style>
        header .song_side::before
        {
           ...
           background: url('img/King/king.png') no-repeat;
...
<body>
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>King</h1>
                <p>Arpan Kumar was born on Saturday, 10 October 1998 
                    <br> in Uttar Pradesh, and later, he shifted to Delhi.
                    <br> His zodiac sign is Libra.
                    <br> He did his schooling at a government school. 
                </p>
                <div class="buttons">
                    <a href="https://www.youtube.com/results?search_query=king+rapper+channel"><button>PLAY</button></a>
                    <a href="https://www.instagram.com/ifeelking/"><button>FOLLOW</button></a>
                </div>    
            </div>
