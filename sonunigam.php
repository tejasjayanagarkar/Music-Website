...
<head>
    ...
    <style>
        header .song_side::before
        {
           ...
           background: url('img/Sonu nigam/sonu_nigam.png') no-repeat;
...
<body>
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Sonu Nigam</h1>
                <p>Sonu Nigam (born 30 July 1973)
                    <br> is an Indian playback singer,
                    <br> music director, dubbing artist and actor.
                    <br> He has been described in the media as one of the best,
                    <br> the most popular and successful playback singers in Hindi and Kannada cinema.
                </p>
                <div class="buttons">
                    <a href="https://www.youtube.com/results?search_query=sonu+nigam+channel"><button>PLAY</button></a>
                    <a href="https://www.instagram.com/sonunigamofficial/"><button>FOLLOW</button></a>
                </div>    
            </div>
    ...
    <script src="sonunigam.js"></script>
</body>
</html>
