...
<head>
    ...
    <style>
        header .song_side::before
        {
           ...
           background: url('img/Abhijeet Bhatacharya/abhijeet.png') no-repeat;
           background-size: 35% auto; /* Adjust the values as needed */
...
<body>
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Abhijeet Bhatacharya</h1>
                <p>(born 30 October 1958)a Bollywood playback singer.<br> Abhijeet has sung 6034 songs in over 1000 films<br>
                    Abhijeet was born to a Kanpur-based Bengali<br>
                     businessman turned editor Dhirendranath Bhattacharya,<br>
                      and his wife Kamladevi Bhattacharya in Kanpur, Uttar Pradesh<br>
                </p>
                <div class="buttons">
                    <a href="https://www.youtube.com/results?search_query=bestofbhattacharya"><button>PLAY</button>
                    <a href="https://www.instagram.com/abhijeetbhattacharya/"><button>FOLLOW</button></a>
                </div>    
            </div>
