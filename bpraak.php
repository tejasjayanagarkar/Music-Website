...
<head>
    ...
    <style>
        header .song_side::before
        {
           ...
           background: url('img/B Praak/b_praak.png') no-repeat;
...
<body>
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>B Praak</h1>
                <p>Pratik Bachan (born 7 February 1986), 
                    <br>best known by his stage name B Praak (formerly Prakky B),
                    <br> is an Indian singer, music director, composer and music producer 
                    <br>associated with the Punjabi and Hindi music industry.
                    <br> He started his career as a music producer, and later debuted as a singer
                    <br> with the song Mann Bharrya.
                    <br>He has won many awards including a National Film Award and two Filmfare Awards.

                </p>
                <div class="buttons">
                    <a href="https://www.youtube.com/results?search_query=b+praak+channel"><button>PLAY</button>
                    <a href="https://www.instagram.com/bpraak/"><button>FOLLOW</button></a>
                </div>    
            </div>
