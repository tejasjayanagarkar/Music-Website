...
const songs = [
    {
        ...
        poster: "img/Atif Aslam/1.jpg",
    },
    {
        id: '2',
        songName: `Apna Bana le<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Atif Aslam/2.jpg",
    },
    {
        id: "3",
        songName: `Desh Mere<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Atif Aslam/3.jpg",
    },
    {
        id: "4",
        songName: `Heer Ranjhana<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Atif Aslam/4.jpg",
    },
    {
        id: "5",
        songName: `Heeriye<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Atif Aslam/5.jpg",
    },
    {
        id: "6",
        songName: `Kala Jadu<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Atif Aslam/6.jpg",
    },
    {
        id: "7",
        songName: `Kesariya<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Atif Aslam/7.jpg",
    },
    {
        id: "8",
        songName: `Har Kisi Ko<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Atif Aslam/8.jpg",
    },
    {
        id: "9",
        songName: `Jab Tak -M.S.Dhoni<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Atif Aslam/9.jpg",
    },
    {
        id: "10",
        songName: `Khairiyat<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Atif Aslam/10.jpg",
    },
    {
        id: "11",
        songName: `Darasal<br><div class="subtitle">Atif Aslam</div>`,
        poster: "img/Atif Aslam/11.jpg",
    },
    {
        id: "12",
        songName: `Dekhte Dekhte<br><div class="subtitle">Atif Aslam</div>`,
        poster: "img/Atif Aslam/12.jpg",
    },
    {
        id: "13",
        songName: `Jeene Laga Hoon<br><div class="subtitle">Atif Aslam</div>`,
        poster: "img/Atif Aslam/13.jpg",
    },
    {
        id: "14",
        songName: `Kabhi To Paas Mere Aao<br>
        <div class="subtitle">Atif Aslam</div>`,
        poster: "img/Atif Aslam/14.jpg",
    },
    {
        id: "15",
        songName: `Pahli Nazar Mein<br><div class="subtitle">Atif Aslam</div>`,
        poster: "img/Atif Aslam/15.jpg",
    },
    {
        id: "16",
        songName: `Pehli Dafa Lofi<br><div class="subtitle">Atif Aslam</div>`,
        poster: "img/Atif Aslam/16.jpg",
    },
    {
        id: "17",
        songName: `Toota Jo Kabhi Taara<br><div class="subtitle">Atif Aslam</div>`,
        poster: "img/Atif Aslam/17.jpg",
    },   
    {
        id: "18",
        songName: `Tu Jaane Na<br><div class="subtitle">Atif Aslam</div>`,
        poster: "img/Atif Aslam/18.jpg",
    }   
]
...
Array.from(document.getElementsByClassName("playlistPlay")).forEach((e)=>{
    e.addEventListener("click", (el)=>{
        ...
        music.src = `audio/Atif Aslam/${index}.mp3`;

        download_music.href = `audio/Atif Aslam/${index}.mp3`;

        poster_master_play.src = `img/Atif Aslam/${index}.jpg`;
        music.play();
        masterPlay.classList.remove("bi-play-fill");
        masterPlay.classList.add("bi-pause-fill");
