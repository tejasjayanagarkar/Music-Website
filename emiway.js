...
const songs = [
    {
        ...
        poster: "img/emiway/1.jpg",
    },
    {
        id: '2',
        songName: `Apna Bana le<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/emiway/2.jpg",
    },
    {
        id: "3",
        songName: `Desh Mere<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/emiway/3.jpg",
    },
    {
        id: "4",
        songName: `Heer Ranjhana<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/emiway/4.jpg",
    },
    {
        id: "5",
        songName: `Heeriye<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/emiway/5.jpg",
    },
    {
        id: "6",
        songName: `Kala Jadu<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/emiway/6.jpg",
    },
    {
        id: "7",
        songName: `Kesariya<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/emiway/7.jpg",
    },
    {
        id: "8",
        songName: `Har Kisi Ko<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/emiway/8.jpg",
    },
    {
        id: "9",
        songName: `Jab Tak -M.S.Dhoni<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/emiway/9.jpg",
    },
    {
        id: "10",
        songName: `Khairiyat<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/emiway/10.jpg",
    },
    {
        id: "11",
        songName: `baby<br><div class="subtitle">emiway</div>`,
        poster: "img/emiway/11.jpg",
    },
    {
        id: "12",
        songName: `Company<br><div class="subtitle">emiway</div>`,
        poster: "img/emiway/12.jpg",
    },
    {
        id: "13",
        songName: `Grind<br><div class="subtitle">emiway</div>`,
        poster: "img/emiway/13.jpg",
    },
    {
        id: "14",
        songName: `Kaun Hai Ye<br>
        <div class="subtitle">emiway</div>`,
        poster: "img/emiway/14.jpg",
    },
    {
        id: "15",
        songName: `Machayenge 4<br><div class="subtitle">emiway</div>`,
        poster: "img/emiway/15.jpg",
    },
    {
        id: "16",
        songName: `Out of Sampark<br><div class="subtitle">emiway</div>`,
        poster: "img/emiway/16.jpg",
    },
    {
        id: "17",
        songName: `Samaj H Mein Aaya Kya<br>
        <div class="subtitle">emiway</div>`,
        poster: "img/emiway/17.jpg",
    },
    {
        id: "18",
        songName: `Kadak Ban<br><div class="subtitle">emiway</div>`,
        poster: "img/emiway/18.jpg",
    },
    {
        id: "19",
        songName: `Pagal Sa Rapper<br><div class="subtitle">emiway</div>`,
        poster: "img/emiway/19.jpg",
    },
]
...
Array.from(document.getElementsByClassName("playlistPlay")).forEach((e)=>{
    e.addEventListener("click", (el)=>{
        ...
        music.src = `audio/emiway/${index}.mp3`;

        download_music.href = `audio/emiway/${index}.mp3`;

        poster_master_play.src = `img/emiway/${index}.jpg`;
        music.play();
        masterPlay.classList.remove("bi-play-fill");
        masterPlay.classList.add("bi-pause-fill");
