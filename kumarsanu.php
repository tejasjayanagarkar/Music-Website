...
<head>
    ...
    <style>
        header .song_side::before
        {
           ...
           background: url('img/KUMAR SANU/kumar sanu.png') no-repeat;
...
<body>
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Kumar Sanu</h1>
                <p>Kedarnath Bhattacharya (born 20 October 1957),
                    <br> professionally known as Kumar Sanu, is an Indian playback singer.
                    <br> He is known as the King of Melody in Bollywood. 
                    <br>He is famous for singing thousands of Bollywood Hindi super hit songs. 
                </p>
                <div class="buttons">
                    <a href="https://www.youtube.com/results?search_query=kumar+sanu+channel"><button>PLAY</button></a>
                    <a href="https://www.instagram.com/kumarsanuofficial/"><button>FOLLOW</button></a>
                </div>    
            </div>
    ...
    <script src="kumarsanu.js"></script>
</body>
</html>
