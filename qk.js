...
const songs = [
    ...
    },
    {
        ...
        poster: "img/QK/10.jpg",
    },
    {
        id: "11",
        songName: `Aaina<br><div class="subtitle">QK</div>`,
        poster: "img/QK/11.jpg",
    },
    {
        id: "12",
        songName: `Chitthi<br><div class="subtitle">QK</div>`,
        poster: "img/QK/12.jpg",
    },
    {
        id: "13",
        songName: `Jehda Nasha<br><div class="subtitle">QK</div>`,
        poster: "img/QK/13.jpg",
    },
    {
        id: "1",
        songName: `Zidd Mein Arya<br><div class="subtitle">QK</div>`,
        poster: "img/QK/14.jpg",
    }      
]
...
Array.from(document.getElementsByClassName("playlistPlay")).forEach((e)=>{
    e.addEventListener("click", (el)=>{
        ...
        music.src = `audio/QK/${index}.mp3`;

        download_music.href = `audio/QK/${index}.mp3`;

        poster_master_play.src = `img/QK/${index}.jpg`;
        music.play();
        masterPlay.classList.remove("bi-play-fill");
        masterPlay.classList.add("bi-pause-fill");
