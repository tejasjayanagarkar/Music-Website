...
<head>
    ...
    header .song_side::before
    {
       ...
       background: url('img/Hardy sindhu/hardy_sandhu.png') no-repeat;
       background-size: 30% auto; /* Adjust the values as needed */
    }
    </style>
</head>
<body>
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Hardy Sandhu</h1>
                <p>Hardavinder Singh Sandhu 
                   <br> (born 6 September 1986)
                   <br> actor and former cricketer who works in Punjabi and Hindi films.
                   <br> His first song was Tequilla Shot, and he gained popularity with Soch 
                   <br>(2013) and Joker (2014), which were written by Jaani and music composed by B Praak.
                   <br> Sandhu made his acting debut in Yaaran Da Katchup (2014).[
                </p>
                <div class="buttons">
                    <a href="https://www.youtube.com/results?search_query=hardy+sindhu+channel"><button>PLAY</button></a>
                    <a href="https://www.instagram.com/harrdysandhu/"><button>FOLLOW</button></a>
                </div>    
            </div>
    ...
    <script src="HardySindhu.js"></script>
</body>
</html>
