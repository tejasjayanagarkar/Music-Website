...
<head>
    ...
    <style>
        header .song_side::before
        {
           ...
           background: url('img/Lata Mangeshkar/lata_mangeshkar.png') no-repeat;
...
<body>
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                ...
                <p>born Hema Mangeshkar; 28 September 1929 – 6 February 2022
                    <br> was an Indian playback singer and occasional music composer.
                    <br> She is considered to be the most celebrated singer in independent India 
                    <br>and one of its most influential artists.
                    <br>Her voice was one of the unifying elements of the peoples
                    <br> of South Asia across borders.
                </p>
                <div class="buttons">
                    <a href="https://www.youtube.com/results?search_query=lata+mangeshkar+channel"><button>PLAY</button></a>
                    <a href="https://www.instagram.com/lata_mangeshkar/"><button>FOLLOW</button></a>
                </div>    
            </div>
    ...
    <script src="latamangeshkar.js"></script>
</body>
</html>
