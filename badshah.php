...
<head>
    ...
    <style>
        header .song_side::before
        {
           ...
           background: url('img/Badshah/badshah1.png') no-repeat;
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                ...
                <h1>Badshah</h1>
                <p>Aditya Prateek Singh Sisodia, (born 19 November 1985),
                    <br> known professionally as Badshah,
                    <br> is an Indian rapper, singer, songwriter,
                    <br> music and film producer and businessman known for his Hindi, Haryanvi, and Punjabi music.
                    <br> He is often regarded one of the greatest and the most influential music artist in India.
                </p>
                <div class="buttons">
                    <a href="https://youtu.be/s4x31AVM3q4?si=VwZpuTLe6YloJigU"><button>PLAY</button></a>
                    <a href="https://www.instagram.com/badboyshah/"><button>FOLLOW</button></a>
                </div>    
            </div>
