...
const songs = [
    ...
    {
        id: "16",
        songName: `Tum Kya Mile<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Arijit singh/16.jpg",
    },
    {
        id: "17",
        songName: `Tum Hi Aana<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Arijit singh/17.jpg",
    },   
    {
        id: "18",
        songName: `Tere Hawale<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Arijit singh/18.jpg",
    },
    {
        id: "19",
        songName: `Mere Yaara<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Arijit singh/19.jpg",
    },
    {
        id: "20",
        songName: `Baaton Ko Teri<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Arijit singh/20.jpg",
    },  
]
...
Array.from(document.getElementsByClassName("playlistPlay")).forEach((e)=>{
    e.addEventListener("click", (el)=>{
        ...
        poster_master_play.src = `img/Arijit Singh/${index}.jpg`;
        music.play();
        masterPlay.classList.remove("bi-play-fill");
        masterPlay.classList.add("bi-pause-fill");
