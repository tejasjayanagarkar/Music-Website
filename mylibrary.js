...
const songs = [
    {
        ...
        poster: "img/my library/1.jpg",
    },
    {
        id: '2',
        songName: `Apna Bana le<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/my library/2.jpg",
    },
    {
        id: "3",
        songName: `Desh Mere<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/my library/3.jpg",
    },
    {
        id: "4",
        songName: `Heer Ranjhana<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/my library/4.jpg",
    },
    {
        id: "5",
        songName: `Heeriye<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/my library/5.jpg",
    },
    {
        id: "6",
        songName: `Kala Jadu<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/my library/6.jpg",
    },
    {
        id: "7",
        songName: `Kesariya<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/my library/7.jpg",
    },
    {
        id: "8",
        songName: `Har Kisi Ko<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/my library/8.jpg",
    },
    {
        id: "9",
        songName: `Jab Tak -M.S.Dhoni<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/my library/9.jpg",
    },
    {
        id: "10",
        songName: `Khairiyat<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/my library/10.jpg",
    },
    {
        id: "11",
        songName: `Arijit Singh Mashup<br>`,
        poster: "img/my library/11.jpg",
    },
    {
        id: "12",
        songName: `Atif Aslam Mashup<br>`,
        poster: "img/my library/12.jpg",
    },
    {
        id: "13",
        songName: `Badshah<br>`,
        poster: "img/my library/13.jpg",
    },
    {
        id: "14",
        songName: `Best of 2021<br>`,
        poster: "img/my library/14.jpg",
    },
    {
        id: "15",
        songName: `KK Mashup<br>`,
        poster: "img/my library/15.jpg",
    }, 
    {
        id: "16",
        songName: `MC Stan Mashup<br>`,
        poster: "img/my library/16.jpg",
    },   
    {
        id: "17",
        songName: `New vs Old 4<br>`,
        poster: "img/my library/17.jpg",
    },
    {
        id: "18",
        songName: `Old vs New Bollywood<br><div class="subtitle">Raj Barman & Deepshika Raina</div>`,
        poster: "img/my library/18.jpg",
    },    
    {
        id: "19",
        songName: `Yo Yo Honey Singh Mashup<br>`,
        poster: "img/my library/19.jpg",
    }
]
...
Array.from(document.getElementsByClassName("playlistPlay")).forEach((e)=>{
    e.addEventListener("click", (el)=>{
        ...
        music.src = `audio/my library/${index}.mp3`;

        download_music.href = `audio/my library/${index}.mp3`;

        poster_master_play.src = `img/my library/${index}.jpg`;
        music.play();
        masterPlay.classList.remove("bi-play-fill");
        masterPlay.classList.add("bi-pause-fill");
