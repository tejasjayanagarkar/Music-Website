...
<head>
    ...
    <style>
        header .song_side::before
        {
           ...
           background: url('img/Guru Randhawa/guru_randhawa.png') no-repeat;
...
<body>
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Guru Randhawa</h1>
                <p>Gursharanjot Singh Randhawa (born 30 August 1991) 
                    <br>is an Indian singer, songwriter and music composer 
                    <br>associated with Punjabi, Bhangra, Indi-pop and Bollywood music. 
                </p>
                <div class="buttons">
                    <a href="https://www.youtube.com/results?search_query=guru+randhawa+channel"><button>PLAY</button></a>
                    <a href="https://www.instagram.com/gururandhawa/"><button>FOLLOW</button></a>
                </div>    
            </div>
    ...
    <script src="gururandhawa.js"></script>
</body>
</html>
