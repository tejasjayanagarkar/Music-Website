...
<head>
    ...
    <style>
        header .song_side::before
        {
           ...
           background: url('img/Paradox/paradox.png') no-repeat;
...
<body>
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Paradox</h1>
                <p>A paradox is a logically self-contradictory statement or
                    <br> a statement that runs contrary to one's expectation. 
                    <br>It is a statement that, despite apparently valid reasoning from true premises,
                    <br> leads to a seemingly self-contradictory or a logically unacceptable conclusion.
                </p>
                <div class="buttons">
                    <a href="https://www.youtube.com/results?search_query=paradox+channel"><button>PLAY</button>
                    <a href="https://www.instagram.com/paradox.here/"><button>FOLLOW</button></a>
                </div>    
            </div>
