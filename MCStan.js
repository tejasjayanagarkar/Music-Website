...
const songs = [
    {
        ...
        poster: "img/MC Stan/1.jpg",
    },
    {
        id: '2',
        songName: `Apna Bana le<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/MC Stan/2.jpg",
    },
    {
        id: "3",
        songName: `Desh Mere<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/MC Stan/3.jpg",
    },
    {
        id: "4",
        songName: `Heer Ranjhana<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/MC Stan/4.jpg",
    },
    {
        id: "5",
        songName: `Heeriye<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/MC Stan/5.jpg",
    },
    {
        id: "6",
        songName: `Kala Jadu<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/MC Stan/6.jpg",
    },
    {
        id: "7",
        songName: `Kesariya<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/MC Stan/7.jpg",
    },
    {
        id: "8",
        songName: `Har Kisi Ko<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/MC Stan/8.jpg",
    },
    {
        id: "9",
        songName: `Jab Tak -M.S.Dhoni<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/MC Stan/9.jpg",
    },
    {
        id: "10",
        songName: `Khairiyat<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/MC Stan/10.jpg",
    },
    {
        id: "11",
        songName: `Basti Ka Hasti<br><div class="subtitle">MC Stan</div>`,
        poster: "img/MC Stan/11.jpg",
    },
    {
        id: "12",
        songName: `Ek din Pyaar<br><div class="subtitle">MC Stan</div>`,
        poster: "img/MC Stan/12.jpg",
    },
    {
        id: "13",
        songName: `Tadipaar<br><div class="subtitle">MC Stan</div>`,
        poster: "img/MC Stan/13.jpg",
    },
    {
        id: "14",
        songName: `307<br><div class="subtitle">MC Stan</div>`,
        poster: "img/MC Stan/14.jpg",
    },
    {
        id: "15",
        songName: `Yede Ki Chadar<br><div class="subtitle">MC Stan</div>`,
        poster: "img/MC Stan/15.jpg",
    },    
    {
        id: "16",
        songName: `Shayad Meri Shaadi<br><div class="subtitle">MC Stan</div>`,
        poster: "img/MC Stan/16.jpg",
    },
]
...
Array.from(document.getElementsByClassName("playlistPlay")).forEach((e)=>{
    e.addEventListener("click", (el)=>{
        ...
        music.src = `audio/MC Stan/${index}.mp3`;

        download_music.href = `audio/MC Stan/${index}.mp3`;

        poster_master_play.src = `img/MC Stan/${index}.jpg`;
        music.play();
        masterPlay.classList.remove("bi-play-fill");
        masterPlay.classList.add("bi-pause-fill");
