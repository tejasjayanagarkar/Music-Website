...
<head>
    ...
    <style>
        header .song_side::before
        {
           ...
           background: url('img/qk/qk.png') no-repeat;
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>QK/h1>
                <p>Aarya Jadhao, 
                    <br>better known by her stage name QK, is an Indian rapper
                    <br>, poet, and songwriter.
                    <br> She also took part in MTV Hustle 2.0,
                    <br> India’s first ever Rap/Hip-Hop reality show.
                    <br>The event was hosted by Krissann Barretto and included Baadshah as a judge
                </p>
                <div class="buttons">
                    <a href="https://www.youtube.com/results?search_query=qk+channel"><button>PLAY</button></a>
                    <a href="https://www.instagram.com/aarya.qk/"><button>FOLLOW</button></a>
                </div>    
            </div>
