...
const songs = [
        {
            ...
            poster: "img/Yo Yo Honey Singh/1.jpg",
        },
        {
            id: '2',
            songName: `Apna Bana le<br><div class="subtitle">Arijit Singh</div>`,
            poster: "img/Yo Yo Honey Singh/2.jpg",
        },
        {
            id: "3",
            songName: `Desh Mere<br><div class="subtitle">Arijit Singh</div>`,
            poster: "img/Yo Yo Honey Singh/3.jpg",
        },
        {
            id: "4",
            songName: `Heer Ranjhana<br><div class="subtitle">Arijit Singh</div>`,
            poster: "img/Yo Yo Honey Singh/4.jpg",
        },
        {
            id: "5",
            songName: `Heeriye<br><div class="subtitle">Arijit Singh</div>`,
            poster: "img/Yo Yo Honey Singh/5.jpg",
        },
        {
            id: "6",
            songName: `Kala Jadu<br><div class="subtitle">Arijit Singh</div>`,
            poster: "img/Yo Yo Honey Singh/6.jpg",
        },
        {
            id: "7",
            songName: `Kesariya<br><div class="subtitle">Arijit Singh</div>`,
            poster: "img/Yo Yo Honey Singh/7.jpg",
        },
        {
            id: "8",
            songName: `Har Kisi Ko<br><div class="subtitle">Arijit Singh</div>`,
            poster: "img/Yo Yo Honey Singh/8.jpg",
        },
        {
            id: "9",
            songName: `Jab Tak -M.S.Dhoni<br><div class="subtitle">Arijit Singh</div>`,
            poster: "img/Yo Yo Honey Singh/9.jpg",
        },
        {
            id: "10",
            songName: `Khairiyat<br><div class="subtitle">Arijit Singh</div>`,
            poster: "img/Yo Yo Honey Singh/10.jpg",
        },
        {
            id: "11",
            songName: `Brown Rang<br><div class="subtitle">Yo Yo Honey Singh</div>`,
            poster: "img/Yo Yo Honey Singh/11.jpg",
        },
        {
            id: "12",
            songName: `chhote chhote peg<br><div class="subtitle">Yo Yo Honey Singh</div>`,
            poster: "img/Yo Yo Honey Singh/12.jpg",
        },
        {
            id: "13",
            songName: `Dheere Dheere Se<br><div class="subtitle">Yo Yo Honey Singh</div>`,
            poster: "img/Yo Yo Honey Singh/13.jpg",
        },
        {
            id: "14",
            songName: `First Kiss<br>
            <div class="subtitle">Yo Yo Honey Singh</div>`,
            poster: "img/Yo Yo Honey Singh/14.jpg",
        },
        {
            id: "15",
            songName: `Lamborghini<br><div class="subtitle">Yo Yo Honey Singh</div>`,
            poster: "img/Yo Yo Honey Singh/15.jpg",
        },
        {
            id: "16",
            songName: `Love Dose<br><div class="subtitle">Yo Yo Honey Singh</div>`,
            poster: "img/Yo Yo Honey Singh/16.jpg",
        },
        {
            id: "17",
            songName: `Saiyaan ji<br><div class="subtitle">Yo Yo Honey Singh</div>`,
            poster: "img/Yo Yo Honey Singh/17.jpg",
        }
]
/*
...
Array.from(document.getElementsByClassName("playlistPlay")).forEach((e)=>{
    e.addEventListener("click", (el)=>{
        ...
        music.src = `audio/Yo Yo Honey Singh/${index}.mp3`;

        download_music.href = `audio/Yo Yo Honey Singh/${index}.mp3`;

        poster_master_play.src = `img/Yo Yo Honey Singh/${index}.jpg`;
        music.play();
        masterPlay.classList.remove("bi-play-fill");
        masterPlay.classList.add("bi-pause-fill");
