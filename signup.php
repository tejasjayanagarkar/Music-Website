            ...
            <div class="content">
                <form method="post">
                    ...
                    <div class="card">
                        ...
                        <input type="password" name="user_re_password" placeholder="Enter Your Password to confirm....." required>
                    </div>
                    <input type="submit" value="Sign Up" class="submit">
                    <div class="check">
                        <input type="checkbox" name="" id=""><span>Remember me.</span>
                    </div>
                    <p>Already have an account..<br>go to<a href="index.php">Log in</a></p>
                </form>
            </div>
        </div>
        <div class="right_bx1">
