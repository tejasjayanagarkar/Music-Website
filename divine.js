...
const songs = [
    {
        ...
        poster: "img/divine/1.jpg",
    },
    {
        id: '2',
        songName: `Apna Bana le<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/divine/2.jpg",
    },
    {
        id: "3",
        songName: `Desh Mere<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/divine/3.jpg",
    },
    {
        id: "4",
        songName: `Heer Ranjhana<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/divine/4.jpg",
    },
    {
        id: "5",
        songName: `Heeriye<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/divine/5.jpg",
    },
    {
        id: "6",
        songName: `Kala Jadu<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/divine/6.jpg",
    },
    {
        id: "7",
        songName: `Kesariya<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/divine/7.jpg",
    },
    {
        id: "8",
        songName: `Har Kisi Ko<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/divine/8.jpg",
    },
    {
        id: "9",
        songName: `Jab Tak -M.S.Dhoni<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/divine/9.jpg",
    },
    {
        id: "10",
        songName: `Khairiyat<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/divine/10.jpg",
    },
    {
        id: "11",
        songName: `City Slum<br><div class="subtitle">divine</div>`,
        poster: "img/divine/11.jpg",
    },
    {
        id: "12",
        songName: `Farak<br><div class="subtitle">divine</div>`,
        poster: "img/divine/12.jpg",
    },
    {
        id: "13",
        songName: `Gunhegar<br><div class="subtitle">divine</div>`,
        poster: "img/divine/13.jpg",
    },
    {
        id: "14",
        songName: `395<br>
        <div class="subtitle">divine</div>`,
        poster: "img/divine/14.jpg",
    },
    {
        id: "15",
        songName: `Mirchi<br><div class="subtitle">divine</div>`,
        poster: "img/divine/15.jpg",
    },
    {
        id: "16",
        songName: `Punya Paap<br><div class="subtitle">divine</div>`,
        poster: "img/divine/16.jpg",
    },
    {
        id: "17",
        songName: `Chal Bombay<br><div class="subtitle">divine</div>`,
        poster: "img/divine/17.jpg",
    }
]
...
Array.from(document.getElementsByClassName("playlistPlay")).forEach((e)=>{
    e.addEventListener("click", (el)=>{
        ...
        music.src = `audio/divine/${index}.mp3`;

        download_music.href = `audio/divine/${index}.mp3`;

        poster_master_play.src = `img/divine/${index}.jpg`;
        music.play();
        masterPlay.classList.remove("bi-play-fill");
        masterPlay.classList.add("bi-pause-fill");
