...
<head>
    ...
    <style>
        header .song_side::before
        {
           ...
           background: url('img/Permish Varma/permish_verma.png') no-repeat;
...
<body>
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Parmish Verma</h1>
                <p>(born 3 July 1990)
                    <br> is an Indian singer, rapper, director and actor associated with the Punjabi Music 
                    <br>and Punjabi Film Industry.
                    <br> He started his career as a video director then singer, 
                    <br>and later debuted as an actor with the film Rocky Mental.

                </p>
                <div class="buttons">
                    <a href="https://www.youtube.com/results?search_query=permish+verma+channel"><button>PLAY</button>
                    <a href="https://www.instagram.com/parmishverma/"><button>FOLLOW</button></a>
                </div>    
            </div>
    ...
    <script src="permishverma.js"></script>
</body>
</html>
