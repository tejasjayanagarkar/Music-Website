...
<head>
    ...
    header .song_side::before
    {
       ...
       background: url('arijitsingh.png') no-repeat;
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                ...
                <h1>Arijit Singh - The Best</h1>
                <p>Hey,Something about him<br> <br>Arijit Singh was born on 25 April 1987<br> Jiaganj, Murshidabad, West Bengal to Kakkar Singh<br>
                    a Punjabi Sikh father and Aditi Singh, a Bengali Hindu mother<br> 
                    Hey, you tell your friends it was nice to meet them<br>
                    But I hope I never see them again<br>
                </p>
                <div class="buttons">
                    <a href="https://www.youtube.com/@Official_ArijitSingh/featured"><button>PLAY</button></a>
                    <a href="https://www.instagram.com/arijitsingh/"><button>FOLLOW</button></a>
                </div>    
            </div>
            ...
            <div class="popular_artists">
              ...
              <li>
                    ...
                    <li>
                       <a href="gururandhawa.php"><img src="img/Guru Randawa/gururandhava.jpg" alt="Guru Randawa" title="Guru Randawa"></a> 
                    </li>
                    <li>
