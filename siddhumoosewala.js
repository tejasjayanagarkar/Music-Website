...
const songs = [
    {
        ...
        poster: "img/Siddhu Moosewala/1.jpg",
    },
    {
        id: '2',
        songName: `Apna Bana le<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Siddhu Moosewala/2.jpg",
    },
    {
        id: "3",
        songName: `Desh Mere<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Siddhu Moosewala/3.jpg",
    },
    {
        id: "4",
        songName: `Heer Ranjhana<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Siddhu Moosewala/4.jpg",
    },
    {
        id: "5",
        songName: `Heeriye<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Siddhu Moosewala/5.jpg",
    },
    {
        id: "6",
        songName: `Kala Jadu<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Siddhu Moosewala/6.jpg",
    },
    {
        id: "7",
        songName: `Kesariya<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Siddhu Moosewala/7.jpg",
    },
    {
        id: "8",
        songName: `Har Kisi Ko<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Siddhu Moosewala/8.jpg",
    },
    {
        id: "9",
        songName: `Jab Tak -M.S.Dhoni<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Siddhu Moosewala/9.jpg",
    },
    {
        id: "10",
        songName: `Khairiyat<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Siddhu Moosewala/10.jpg",
    },
    {
        id: "11",
        songName: `295-Legand<br><div class="subtitle">Siddhu Moosewala</div>`,
        poster: "img/Siddhu Moosewala/11.jpg",
    },
    {
        id: "12",
        songName: `Death Dream <br><div class="subtitle">Siddhu Moosewala</div>`,
        poster: "img/Siddhu Moosewala/12.jpg",
    },
    {
        id: "13",
        songName: `Mirza<br><div class="subtitle">Siddhu Moosewala</div>`,
        poster: "img/Siddhu Moosewala/13.jpg",
    },
    {
        id: "14",
        songName: `So High<br><div class="subtitle">Siddhu Moosewala</div>`,
        poster: "img/Siddhu Moosewala/14.jpg",
    }, 
    {
        id: "15",
        songName: `Dhakka Na Karo<br><div class="subtitle">Siddhu Moosewala</div>`,
        poster: "img/Siddhu Moosewala/15.jpg",
    },   
]
...
Array.from(document.getElementsByClassName("playlistPlay")).forEach((e)=>{
    e.addEventListener("click", (el)=>{
        ...
        music.src = `audio/Siddhu Moosewala/${index}.mp3`;

        download_music.href = `audio/Siddhu Moosewala/${index}.mp3`;

        poster_master_play.src = `img/Siddhu Moosewala/${index}.jpg`;
        music.play();
        masterPlay.classList.remove("bi-play-fill");
        masterPlay.classList.add("bi-pause-fill");
