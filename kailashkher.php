...
<head>
    ...
    <style>
        header .song_side::before
        {
           ...
           background: url('img/Kailash Kher/kailash kher.png') no-repeat;
...
<body>
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Kailash Kher</h1>
                <p>born 7 July 1973 is an Indian music composer and singer. 
                    <br>He sings songs with a music style influenced by Indian folk music and Sufi music.
                    <br> He was inspired by the classical musicians' Pandit Kumar Gandharva,
                    <br> Pandit Hridaynath Mangeshkar,
                    <br> Pandit Bhimsen Joshi, and the Qawwali singer Nusrat Fateh Ali Khan.
                </p>
                <div class="buttons">
                    <a href="https://www.youtube.com/results?search_query=kailash+kher+channel"><button>PLAY</button></a>
                    <a href="https://www.instagram.com/kailashkher/"><button>FOLLOW</button></a>
                </div>    
            </div>
    ...
    <script src="kailashkher.js"></script>
</body>
</html>
