...
<head>
    ...
    <style>
        header .song_side::before
        {
           ...
           background: url('img/Shrusti Tawade/shrushti tawade.png') no-repeat;
...
<body>
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Srushti Tawade</h1>
                <p>An Indian singer, rapper, writer, and satirist,
                    <br> made a remarkable appearance in
                    <br> an Indian hip-hop talent hunt reality show ‘MTV Hustle 2.0’ (2022)
                    <br> with her songs such as ‘Chill Kinda Guy’ and ‘Main Nahi Toh Koun.’
                </p>
                <div class="buttons">
                    <a href="https://www.youtube.com/results?search_query=shrushti+tawade+channel"><button>PLAY</button></a>
                    <a href="https://www.instagram.com/srushtinahitohkaun/"><button>FOLLOW</button></a>
                </div>    
            </div>
    ...
    <script src="shrushtitawade.js"></script>
</body>
</html>
