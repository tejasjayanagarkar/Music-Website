...
<head>
    ...
    <style>
        header .song_side::before
        {
           ...
           background: url('img/Shreya Ghosal/shreya1.png') no-repeat;
           background-size: 15% auto; /* Adjust the values as needed */    
        }
    </style>
</head>
<body>
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
            <h1>Shreya Ghosal</h1>
                <p>(born 12 March 1984) 
                    <br>Noted for her wide vocal range and versatility, 
                    <br>she is one of the most prolific and popular singers of India.
                    <br> She has recorded songs for films and albums in various Indian and foreign languages 
                    <br>and received numerous accolades, including five National Film Awards,
                    <br> four Kerala State Film Awards, two Tamil Nadu State Film Awards,
                    <br> two BFJA Awards, seven Filmfare Awards and ten Filmfare Awards South.

                </p>

                <div class="buttons">
                    <a href="https://www.youtube.com/results?search_query=shreya+ghoshal+channel"><button>PLAY</button></a>
                    <a href="https://www.instagram.com/shreyaghoshal/"><button>FOLLOW</button></a>
                </div>    
            </div>
    ...
    <script src="Shreyaghosal.js"></script>
</body>
</html>
