...
<head>
    ...
    <style>
        header .song_side::before
        {
           ...
           background: url('img/neha kakkar/neha_kakkar.png') no-repeat;
...
<body>
        ...
        <div class="song_side">
            ...
            <div class="content">
                ...
                <p>born 6 June 1988,
                    ...
                    <br>She is the younger sister of playback singers Tony Kakkar and Sonu Kakkar. 
                </p>
                <div class="buttons">
                    <a href="https://www.youtube.com/results?search_query=neha+kakkar+channel"><button>PLAY</button></a>
                    <a href="https://www.instagram.com/nehakakkar/"><button>FOLLOW</button></a>
                </div>    
            </div>
    ...
    <script src="nehakakkar.js"></script>
</body>
</html>
