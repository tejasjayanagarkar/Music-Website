...
<head>
    ...
    <style>
        header .song_side::before
        {
           ...
           background: url('img/Emiway/emiway.png') no-repeat;
...
<body>
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Emiway Bantai</h1>
                <p>Emiway Bantai was born on 13 November 1995 
                    <br>in Bengaluru, Karnataka, India.
                    <br> He was born as Bilal Shaikh in a middle-class orthodox Muslim Family.
                    <br> His family has roots in Karnataka.
                </p>
                <div class="buttons">
                    <a href="https://www.youtube.com/results?search_query=emiway+channel"><button>PLAY</button></a>
                    <a href="https://www.instagram.com/emiwaybantai/"><button>FOLLOW</button></a>
                </div>    
            </div>
