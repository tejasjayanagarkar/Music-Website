...
const songs = [
    {
        ...
        poster: "img/Kumar Sanu/1.jpg",
    },
    {
        id: '2',
        songName: `Apna Bana le<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Kumar Sanu/2.jpg",
    },
    {
        id: "3",
        songName: `Desh Mere<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Kumar Sanu/3.jpg",
    },
    {
        id: "4",
        songName: `Heer Ranjhana<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Kumar Sanu/4.jpg",
    },
    {
        id: "5",
        songName: `Heeriye<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Kumar Sanu/5.jpg",
    },
    {
        id: "6",
        songName: `Kala Jadu<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Kumar Sanu/6.jpg",
    },
    {
        id: "7",
        songName: `Kesariya<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Kumar Sanu/7.jpg",
    },
    {
        id: "8",
        songName: `Har Kisi Ko<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Kumar Sanu/8.jpg",
    },
    {
        id: "9",
        songName: `Jab Tak -M.S.Dhoni<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Kumar Sanu/9.jpg",
    },
    {
        id: "10",
        songName: `Khairiyat<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Kumar Sanu/10.jpg",
    },
    {
        id: "11",
        songName: `Ankhone Main Hai Kya<br><div class="subtitle">Kumar Sanu & Alka Yadnik</div>`,
        poster: "img/Kumar Sanu/11.jpg",
    },
    {
        id: "12",
        songName: `Dil Cheer Ke Dekh<br><div class="subtitle">Kumar Sanu</div>`,
        poster: "img/Kumar Sanu/12.jpg",
    },
    {
        id: "13",
        songName: `Ladki Badi Anjani Hai<br><div class="subtitle">Kumar Sanu</div>`,
        poster: "img/Kumar Sanu/13.jpg",
    },
    {
        id: "14",
        songName: `Ram Jaane<br>
        <div class="subtitle">Kumar Sanu</div>`,
        poster: "img/Kumar Sanu/14.jpg",
    },
    {
        id: "15",
        songName: `Sun Meri Shahzadi<br><div class="subtitle">Kumar Sanu</div>`,
        poster: "img/Kumar Sanu/15.jpg",
    },
    {
        id: "16",
        songName: `Tomaro Chokh<br><div class="subtitle">Kumar Sanu</div>`,
        poster: "img/Kumar Sanu/16.jpg",
    },
    {
        id: "17",
        songName: `Yeh Kaali Kaali Aankhen<br><div class="subtitle">Kumar Sanu</div>`,
        poster: "img/Kumar Sanu/17.jpg",
    } 
]
...
Array.from(document.getElementsByClassName("playlistPlay")).forEach((e)=>{
    e.addEventListener("click", (el)=>{
        ...
        music.src = `audio/Kumar Sanu/${index}.mp3`;

        download_music.href = `audio/Kumar Sanu/${index}.mp3`;

        poster_master_play.src = `img/Kumar Sanu/${index}.jpg`;
        music.play();
        masterPlay.classList.remove("bi-play-fill");
        masterPlay.classList.add("bi-pause-fill");
