...
<head>
    ...
    <style>
        header .song_side::before
        {
           ...
           background: url('img/Shan/shan.png') no-repeat;
           background-size: 20% auto; /* Adjust the values as needed */    
        }
        </style>
</head>
<body>
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Shan</h1>
                <p>Shantanu Mukherjee (born 30 September 1972), 
                    <br>better known as Shaan, is an Indian playback singer,
                    <br> live performer, composer, actor and television host. 
                    <br>He has recorded numerous songs for 
                    <br>films and albums in various Indian languages and has established
                    <br> himself as one of the best and highest paid playback singers of Indian Cinema.
                </p>
                <div class="buttons">
                    <a href="https://www.youtube.com/results?search_query=shan+singer+channel"><button>PLAY</button></a>
                    <a href="https://www.instagram.com/singer_shaan/"><button>FOLLOW</button></a>
                </div>    
            </div>
            ...
            <div class="popular_artists">
              ...
              <div class="item Artists_bx">
                    ...
                    <li>
                        <a href="abhijeetbhatacharya.php"><img src="img/Abhijeet Bhatacharya/abhijeet.jfif" alt="Abhijeet Bhatacharya" title="Abhijeet Bhatacharya"><img src="img/Atif Aslam/atifaslam.jpg" alt="Atif Aslam" title="Atif Aslam">
                    </li>
                    <li>
