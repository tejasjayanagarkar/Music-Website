...
const songs = [
    {
        ...
        poster: "img/Nikita Gandhi/1.jpg",
    },
    {
        id: '2',
        songName: `Apna Bana le<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Nikita Gandhi/2.jpg",
    },
    {
        id: "3",
        songName: `Desh Mere<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Nikita Gandhi/3.jpg",
    },
    {
        id: "4",
        songName: `Heer Ranjhana<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Nikita Gandhi/4.jpg",
    },
    {
        id: "5",
        songName: `Heeriye<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Nikita Gandhi/5.jpg",
    },
    {
        id: "6",
        songName: `Kala Jadu<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Nikita Gandhi/6.jpg",
    },
    {
        id: "7",
        songName: `Kesariya<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Nikita Gandhi/7.jpg",
    },
    {
        id: "8",
        songName: `Har Kisi Ko<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Nikita Gandhi/8.jpg",
    },
    {
        id: "9",
        songName: `Jab Tak -M.S.Dhoni<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Nikita Gandhi/9.jpg",
    },
    {
        id: "10",
        songName: `Khairiyat<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Nikita Gandhi/10.jpg",
    },
    {
        id: "11",
        songName: `Bad Boy X Bad Girl<br><div class="subtitle">Nikita Gandhi & Badshah</div>`,
        poster: "img/Nikita Gandhi/11.jpg",
    },
    {
        id: "12",
        songName: `Kaala Jadu<br><div class="subtitle">Nikita Gandhi & Arijit Singh</div>`,
        poster: "img/Nikita Gandhi/12.jpg",
    },
    {
        id: "13",
        songName: `Mere Khayalon Ki Malika 2<br><div class="subtitle">Nikita Gandhi & Alka Yadnik</div>`,
        poster: "img/Nikita Gandhi/13.jpg",
    },
    {
        id: "14",
        songName: `Param Sundari<br>
        <div class="subtitle">Nikita Gandhi & A.R.Rahman</div>`,
        poster: "img/Nikita Gandhi/14.jpg",
    },
    {
        id: "15",
        songName: `Do You Love Me<br><div class="subtitle">Nikita Gandhi</div>`,
        poster: "img/Nikita Gandhi/15.jpg",
    },
    {
        id: "16",
        songName: `Maharani<br><div class="subtitle">Nikita Gandhi</div>`,
        poster: "img/Nikita Gandhi/16.jpg",
    },
    {
        id: "17",
        songName: `Main Teri Ho Gayi<br><div class="subtitle">Nikita Gandhi</div>`,
        poster: "img/Nikita Gandhi/27.jpg",
    },    
]
...
Array.from(document.getElementsByClassName("playlistPlay")).forEach((e)=>{
    e.addEventListener("click", (el)=>{
        ...
        music.src = `audio/Nikita Gandhi/${index}.mp3`;

        download_music.href = `audio/Nikita Gandhi/${index}.mp3`;

        poster_master_play.src = `img/Nikita Gandhi/${index}.jpg`;
        music.play();
        masterPlay.classList.remove("bi-play-fill");
        masterPlay.classList.add("bi-pause-fill");
