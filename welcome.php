...
<body>
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>halsey - Closer</h1>
                <p>Hey, I was doing just fine before I met you<br> drink too much and that's an issue, but I'm okay<br>
                    Hey, you tell your friends it was nice to meet them<br>
                    But I hope I never see them again<br>
                </p>
                <div class="buttons">
                    <a href="https://www.youtube.com/results?search_query=alanwalkersongs+channel"><button>PLAY</button></a>
                    <a href="https://www.instagram.com/alanwalkermusic"><button>FOLLOW</button></a>
                </div>    
            </div>
