...
const songs = [
    {
        ...
        poster: "img/Permish varma/1.jpg",
    },
    {
        id: '2',
        songName: `Apna Bana le<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Permish varma/2.jpg",
    },
    {
        id: "3",
        songName: `Desh Mere<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Permish varma/3.jpg",
    },
    {
        id: "4",
        songName: `Heer Ranjhana<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Permish varma/4.jpg",
    },
    {
        id: "5",
        songName: `Heeriye<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Permish varma/5.jpg",
    },
    {
        id: "6",
        songName: `Kala Jadu<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Permish varma/6.jpg",
    },
    {
        id: "7",
        songName: `Kesariya<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Permish varma/7.jpg",
    },
    {
        id: "8",
        songName: `Har Kisi Ko<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Permish varma/8.jpg",
    },
    {
        id: "9",
        songName: `Jab Tak -M.S.Dhoni<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Permish varma/9.jpg",
    },
    {
        id: "10",
        songName: `Khairiyat<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Permish varma/10.jpg",
    },
    {
        id: "11",
        songName: `Check it out<br><div class="subtitle">Permish varma</div>`,
        poster: "img/Permish varma/11.jpg",
    },
    {
        id: "12",
        songName: `4 peg<br><div class="subtitle">Permish varma</div>`,
        poster: "img/Permish varma/12.jpg",
    },
    {
        id: "13",
        songName: `look Classy<br><div class="subtitle">Permish varma</div>`,
        poster: "img/Permish varma/13.jpg",
    },   
]
...
Array.from(document.getElementsByClassName("playlistPlay")).forEach((e)=>{
    e.addEventListener("click", (el)=>{
        ...
        music.src = `audio/Permish varma/${index}.mp3`;

        download_music.href = `audio/Permish varma/${index}.mp3`;

        poster_master_play.src = `img/Permish varma/${index}.jpg`;
        music.play();
        masterPlay.classList.remove("bi-play-fill");
        masterPlay.classList.add("bi-pause-fill");
