...
<head>
    ...
    header .song_side::before
    {
       ...
       background: url('sachin-pilgaonkar.png') no-repeat;
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                ...
                <div class="buttons">
                    <a href="https://www.youtube.com/results?search_query=marathi new song"><button>PLAY</button></a>
