...
const songs = [
    {
        ...
        poster: "img/Kailash Kher/1.jpg",
    },
    {
        id: '2',
        songName: `Apna Bana le<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Kailash Kher/2.jpg",
    },
    {
        id: "3",
        songName: `Desh Mere<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Kailash Kher/3.jpg",
    },
    {
        id: "4",
        songName: `Heer Ranjhana<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Kailash Kher/4.jpg",
    },
    {
        id: "5",
        songName: `Heeriye<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Kailash Kher/5.jpg",
    },
    {
        id: "6",
        songName: `Kala Jadu<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Kailash Kher/6.jpg",
    },
    {
        id: "7",
        songName: `Kesariya<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Kailash Kher/7.jpg",
    },
    {
        id: "8",
        songName: `Har Kisi Ko<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Kailash Kher/8.jpg",
    },
    {
        id: "9",
        songName: `Jab Tak -M.S.Dhoni<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Kailash Kher/9.jpg",
    },
    {
        id: "10",
        songName: `Khairiyat<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Kailash Kher/10.jpg",
    },
    {
        id: "11",
        songName: `Ab Tumhare Hawale Watan<br><div class="subtitle">Kailash Kher</div>`,
        poster: "img/Kailash Kher/11.jpg",
    },
    {
        id: "12",
        songName: `Chaand Sifarish<br><div class="subtitle">Kailash Kher</div>`,
        poster: "img/Kailash Kher/12.jpg",
    },
    {
        id: "13",
        songName: `Mere Nishaan<br><div class="subtitle">Kailash Kher</div>`,
        poster: "img/Kailash Kher/13.jpg",
    },
    {
        id: "14",
        songName: `Shankar Ji ka Damru Baje<br>
        <div class="subtitle">Kailash Kher</div>`,
        poster: "img/Kailash Kher/14.jpg",
    },
    {
        id: "15",
        songName: `Teri Deewani<br><div class="subtitle">Kailash Kher</div>`,
        poster: "img/Kailash Kher/15.jpg",
    }    
]
...
Array.from(document.getElementsByClassName("playlistPlay")).forEach((e)=>{
    e.addEventListener("click", (el)=>{
        ...
        music.src = `audio/Kailash Kher/${index}.mp3`;

        download_music.href = `audio/Kailash Kher/${index}.mp3`;

        poster_master_play.src = `img/Kailash Kher/${index}.jpg`;
        music.play();
        masterPlay.classList.remove("bi-play-fill");
        masterPlay.classList.add("bi-pause-fill");
