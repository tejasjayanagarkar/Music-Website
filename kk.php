...
<head>
    ...
    <style>
        header .song_side::before
        {
           ...
           background: url('img/kk/kk.png') no-repeat;
...
<body>
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>KK</h1>
                <p>Krishnakumar Kunnath (23 August 1968 – 31 May 2022)
                    <br>, popularly known as KK, was an Indian playback singer.
                    <br> He recorded songs in Hindi, Tamil, Telugu, Kannada, Malayalam,
                    <br> Marathi, Odia, Bengali, Assamese and Gujarati.
                </p>
                <div class="buttons">
                    <a href="https://www.youtube.com/results?search_query=kk+singer+channel"><button>PLAY</button></a>
                    <a href="https://www.instagram.com/kk_live_now/"><button>FOLLOW</button></a>
                </div>    
            </div>
