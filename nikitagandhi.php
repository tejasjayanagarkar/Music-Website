...
<head>
    ...
    <style>
        header .song_side::before
        {
           ...
           background: url('img/Nikita Gandhi/nikita_gandhi.png') no-repeat;
...
<body>
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
            <h1>Nikhita Gandhi</h1>
                <p>(born 1 October 1991)
                    <br> is an Indian playback singer 
                    <br>who has worked in Indian films in four different languages.
                    <br> She has worked on Tamil, Hindi, Telugu, Bengali, and Kannada film projects.
                </p>
                <div class="buttons">
                    <a href="https://www.youtube.com/results?search_query=nikita+gandhi+channel"><button>PLAY</button></a>
                    <a href="https://www.instagram.com/nikhitagandhiofficial/"><button>FOLLOW</button></a>
                </div>    
            </div>
    ...
    <script src="Nikitagandhi.js"></script>
</body>
</html>
