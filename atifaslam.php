...
<head>
    ...
    <style>
        header .song_side::before
        {
           ...
           background: url('img/Atif Aslam/atfi_aslam.png') no-repeat;
...
<body>
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                 <h1>Atif Aslam</h1>
                 <p>(Urdu: عاطف اسلم, born 12 March 1983) is a Pakistani playback singer,<br>
                       songwriter, composer, and actor.
                        <br> He has recorded many songs in both Pakistan and India,
                        <br> and is known for his vocal belting technique.
                 </p>
                <div class="buttons">
                    <a href="https://youtu.be/b4R2qtmvbqc?si=Y1xHTt610-gZIyKv"><button>PLAY</button></a>
                    <a href="https://www.instagram.com/atifaslam"><button>FOLLOW</button></a>
                </div>    
            </div>
    ...
    <script src="atifaslam.js"></script>
</body>
</html>
