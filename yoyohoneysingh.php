...
<head>
    ...
    <style>
        header .song_side::before
        {
           ...
           background: url('img/Yo Yo Honey Singh/yo yo honey sing.png') no-repeat;
           background-size: 25% auto; /* Adjust the values as needed */
...
<body>
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                ...
                <p>Hirdesh Singh (born 15 March 1983)
                    <br> professionally as Yo Yo Honey Singh 
                    <br> is a controversial Indian music producer. 
                    <br>He is known for his misogynistic and offensive songs.
                    <br> He started in 2003 as a session and recording artist, 
                    <br>and became a bhangra and hip hop music producer.
                </p>
                <div class="buttons">
                    <a href="https://youtu.be/iwL4pu1c6VY?si=Gf3Isx6Nrqagy5aC"><button>PLAY</button></a>
                    <a href="https://www.instagram.com/yoyohoneysingh/"><button>FOLLOW</button></a>
                </div>    
            </div>
    ...
    <script src="yoyohoneySingh.js"></script>
</body>
</html>
