...
const songs = [
    {
        ...
        poster: "img/marathi/1.jpg",
    },
    {
        id: '2',
        songName: `Apna Bana le<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/marathi/2.jpg",
    },
    {
        id: "3",
        songName: `Desh Mere<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/marathi/3.jpg",
    },
    {
        id: "4",
        songName: `Heer Ranjhana<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/marathi/4.jpg",
    },
    {
        id: "5",
        songName: `Heeriye<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/marathi/5.jpg",
    },
    {
        id: "6",
        songName: `Kala Jadu<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/marathi/6.jpg",
    },
    {
        id: "7",
        songName: `Kesariya<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/marathi/7.jpg",
    },
    {
        id: "8",
        songName: `Har Kisi Ko<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/marathi/8.jpg",
    },
    {
        id: "9",
        songName: `Jab Tak -M.S.Dhoni<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/marathi/9.jpg",
    },
    {
        id: "10",
        songName: `Khairiyat<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/marathi/10.jpg",
    },   
    {
        id: "11",
        songName: `Bedhund Me Abhas<br><div class="subtitle">Vindhyashish Sonar</div>`,
        poster: "img/marathi/11.jpg",
    },
    {
        id: "12",
        songName: `Devak Kalji Re<br><div class="subtitle">Ajay Atul</div>`,
        poster: "img/marathi/12.jpg",
    },
    {
        id: "13",
        songName: `Kajwa<br><div class="subtitle">Nick Shinde</div>`,
        poster: "img/marathi/13.jpg",
    },
    {
        id: "14",
        songName: `Kevdyacha Paan Tu<br><div class="subtitle">Ajay Gogavale,Aarya Ambekar</div>`,
        poster: "img/marathi/14.jpg",
    },
    {
        id: "15",
        songName: `Nauvari<br><div class="subtitle">Sanju Rathod</div>`,
        poster: "img/marathi/15.jpg",
    }
]
...
Array.from(document.getElementsByClassName("playlistPlay")).forEach((e)=>{
    e.addEventListener("click", (el)=>{
        ...
        music.src = `audio/marathi/${index}.mp3`;

        download_music.href = `audio/marathi/${index}.mp3`;

        poster_master_play.src = `img/marathi/${index}.jpg`;
        music.play();
        masterPlay.classList.remove("bi-play-fill");
        masterPlay.classList.add("bi-pause-fill");
