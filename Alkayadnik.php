...
<head>
    ...
    <style>
        header .song_side::before
        {
           ...
           background: url('img/Alka Yadnik/Alka Yadnik.png') no-repeat;
           background-size: 22% auto; /* Adjust the values as needed */
...
<body>
    ...
    <header>
        ...
        <div class="song_side">
            <nav>
                ...
                <div class="content">
                      <h1>Alka Yadnik</h1>
                        <p>Alka Yagnik is an Indian playback singer <br>
                             who works predominantly in Hindi cinema.
                             <br> One of the most prominent singers of 90s era of Bollywood, 
                             <br>she has received several accolades including two National Film Awards,
                             <br> two Bengal Film Journalists' Association Awards 
                             <br>and a record seven Filmfare Awards for 
                             <br>Best Female Playback Singer[note 1] from a record of thirty-six nominations
                        </p>
                     <div class="buttons">
                        <a href="https://www.youtube.com/results?search_query=bestofalkayadnik"><button>PLAY</button>
                        <a href="https://www.instagram.com/therealalkayagnik/"><button>FOLLOW</button></a>
                     </div>    
                </div>
            ...
            <div class="popular_artists">
              ...
              <div class="item Artists_bx">
                    ...
                    <li>
                       <a href="gururandhawa.php"><img src="img/Guru Randhawa/gururandhava.jpg" alt="Guru Randhawa" title="Guru Randhawa"></a> 
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="latamangeshkar.php"><img src="img/Lata Mangeshkar/latamngeshkar.jfif" alt="Lata Mangeshkar" title="Lata Mangeshkar"></a>
                    </li>
                    <li>
    ...
    <script src="AlkaYadnik.js"></script>
</body>
</html>
