...
<head>
    ...
    <style>
        header .song_side::before
        {
           ...
           background: url('img/Siddhu Moosewala/siddhu_moosewala.png') no-repeat;
           background-size: 40% auto; /* Adjust the values as needed */    
        }
        </style>
</head>
<body>
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Siddu Moosewala</h1>
                <p>Shubhdeep Singh Sidhu (11 June 1993 – 29 May 2022),
                    <br> known professionally as Sidhu Moose Wala
                    <br> was an Indian rapper, singer and songwriter.
                    <br> He worked predominantly in Punjabi-language music and cinema.
                    <br> He is generally regarded to have been one of the greatest Punjabi artists of his generation
                    <br>and to many, amongst the greatest Punjabi artists of all time.
                    <br> Moreover, he was considered a key figure in opening the door to mainstream music for Punjabi artists.
                </p>
                <div class="buttons">
                    <a href="https://www.youtube.com/results?search_query=sidhu+moose+wala+non+stop"><button>PLAY</button></a>
                    <a href="https://www.instagram.com/sidhumoosewala"><button>FOLLOW</button></a>
                </div>    
            </div>
    ...
    <script src="siddhumoosewala.js"></script>
</body>
</html>
