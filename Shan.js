...
const songs = [
    {
        ...
        poster: "img/Shan/1.jpg",
    },
    {
        id: '2',
        songName: `Apna Bana le<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Shan/2.jpg",
    },
    {
        id: "3",
        songName: `Desh Mere<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Shan/3.jpg",
    },
    {
        id: "4",
        songName: `Heer Ranjhana<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Shan/4.jpg",
    },
    {
        id: "5",
        songName: `Heeriye<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Shan/5.jpg",
    },
    {
        id: "6",
        songName: `Kala Jadu<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Shan/6.jpg",
    },
    {
        id: "7",
        songName: `Kesariya<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Shan/7.jpg",
    },
    {
        id: "8",
        songName: `Har Kisi Ko<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Shan/8.jpg",
    },
    {
        id: "9",
        songName: `Jab Tak -M.S.Dhoni<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Shan/9.jpg",
    },
    {
        id: "10",
        songName: `Khairiyat<br><div class="subtitle">Arijit Singh</div>`,
        poster: "img/Shan/10.jpg",
    },
    {
        id: "11",
        songName: `Beete Hue Pal<br><div class="subtitle">Shan</div>`,
        poster: "img/Shan/11.jpg",
    },
    {
        id: "12",
        songName: `Do U Know<br><div class="subtitle">Shan</div>`,
        poster: "img/Shan/12.jpg",
    },
    {
        id: "13",
        songName: `Haan Yahi Pyaar Hai<br><div class="subtitle">Shan</div>`,
        poster: "img/Shan/13.jpg",
    },
    {
        id: "14",
        songName: `Nazar Mila<br><div class="subtitle">Shan</div>`,
        poster: "img/Shan/14.jpg",
    },
    {
        id: "15",
        songName: `Tasveer<br><div class="subtitle">Shan</div>`,
        poster: "img/Shan/15.jpg",
    },
...
Array.from(document.getElementsByClassName("playlistPlay")).forEach((e)=>{
    e.addEventListener("click", (el)=>{
        ...
        music.src = `audio/Shan/${index}.mp3`;

        download_music.href = `audio/Shan/${index}.mp3`;

        poster_master_play.src = `img/Shan/${index}.jpg`;
        music.play();
        masterPlay.classList.remove("bi-play-fill");
        masterPlay.classList.add("bi-pause-fill");
